...
public class ComparableAndComparatorTest implements Serializable {
    ...
    /**
     * @description: 实现 Comparable 接口的类可以被 Arrays.sort() 和 Collections.sort() 直接排序
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: 对于 null 应该抛出 NullPointerException
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: equals() 和 compareTo() 在表示相等的时候，行为应当一致，否则会出现奇怪的问题。
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: JDK 提供的类中，除了 BigDecimal，其他的全部保证 equals() 和 compareTo()
     *              在表示相等的时候行为一致，因为 BigDecimal 需要考虑精度问题
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: 自然排序满足如下条件时是升序排序，应当保证此时语义和现实语义相符：
     *                      o.compareTo() < 0
     *                      o.compareTo() > 0
     *                      o.compareTo() == 0
     * @params:
    ...
    /**
     * @description: comparator 是精确的排序，也就是说当 comparable 和 comparator 同时存在的时候以 comparator 为齐
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: 当 comparator 行为和 equals() 不一致时表现得很 strange
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
    ...
    /**
     * @description: 传入 Comparator 的 SortMap 或 SortSet 如果进行序列化，必须让 Comparator 实现 Serializable 接口。
    ...
    /**
     * @description: Comparator 可以支持 null
     * @params:
     * @return void
     * @author: 01395265
     * @date: 2020/7/30
